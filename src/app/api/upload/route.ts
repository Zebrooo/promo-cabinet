...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    void reportErrorToBff({ service: 'promo-cabinet', source: 'server', message: err instanceof Error ? err.message : String(err), errorType: err instanceof Error ? err.name : null, stack: err instanceof Error ? (err.stack ?? null) : null, route: '/api/upload' }).catch(() => {});
